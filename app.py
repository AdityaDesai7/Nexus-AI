...
from ui.ai_agents_v2 import show_ai_agents_page_v2
...
# -----------------------------
# Local Imports (IMPORTANT)
# These work because app.py is inside "trading_bot/"
# -----------------------------
from main import (
    fetch_and_enhance,
    get_trading_system,
...
# Optional institutional page
try:
    from ui.institutional_analysis import show_institutional_analysis
    HAS_INST = True
except Exception:
    HAS_INST = False

# Optional education page
try:
    from agents.agents_educational_guide import AgentEducationalGuide
    HAS_EDU = True
except Exception:
